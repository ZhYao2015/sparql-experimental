...
public class Configuration implements OWLReasonerConfiguration, Cloneable,
	...
	public Set<OWLClass> getClosedConcepts() {
		return null != this.closedConcepts ? new HashSet<OWLClass>(this.closedConcepts) : new HashSet<OWLClass>();
	}
	...
	public Set<OWLObjectProperty> getClosedRoles() {
		return null != this.closedRoles ? new HashSet<OWLObjectProperty>(this.closedRoles) : new HashSet<OWLObjectProperty>();
	}
