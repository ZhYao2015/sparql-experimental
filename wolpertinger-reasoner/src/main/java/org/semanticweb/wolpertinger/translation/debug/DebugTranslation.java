 ...
 * corresponds to a justification for the inconsistency of the input ontology.
 * <p>
 *
 * </p>
 *
...
public class DebugTranslation implements OWLOntologyTranslator {
	...
	public void translateOntology(OWLOntology rootOntology, OWLOntology axiomsToBeJustified) throws TranslationException {
...
//		translateOntology(axioms);
			...
			try {
				...
				for(OWLAxiom axiom : axiomsToBeJustified.getAxioms()) {
					if (axiom instanceof OWLDeclarationAxiom) {
						...
						throw new TranslationException("Complex axioms not yet supported!");
					}
				}
				...
				translateOntologyAxioms(axiomNormalization.getM_axioms());
	...
	public void translateOntology(OWLOntology rootOntology) throws TranslationException {
		translateOntology(loadOntology(rootOntology));
//		OWLAxioms axioms = new OWLAxioms();
//
//		Collection<OWLOntology> importClosure = rootOntology.getImportsClosure();
...
//		}
	...
	public Set<OWLAxiom> retranslateSolution(String solution) {
		throw new TranslationException("Retranslation not supported for DebugTranslation.");
	}
...
//	}
	...
	public void visit(OWLAnnotationAssertionAxiom arg0) {
		throw new TranslationException("Unsupported Axiom");
	}
	...
	public void visit(OWLObjectComplementOf objComplementOf) {
		...
		//
			...
			throw new TranslationException("Complement of OLWObjectOneOf not yet supported.");
		}
	}
